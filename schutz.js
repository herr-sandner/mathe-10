...
(function () {
  ...
  function bauen() {
    ...
    ov.innerHTML =
      ...
      '<h1 style="font-size:1.2rem;font-weight:600;color:#33302c;margin:0 0 1rem">Freiwillige Kontrollaufgaben Mathe 10/1</h1>' +
      ...
      '<p id="pw-fehler" style="color:#5b8fe0;font-size:.85rem;min-height:1.2rem;margin:.5rem 0 0"></p>' +
      "</div>";
